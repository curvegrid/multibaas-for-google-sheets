  ...
  const testCases = [
    ...
    },
    {
      ...
      expected: [
        ...
        ['CancelKey', '', '4 inputs:\ntokenId uint256\nowner address\nsendTo address\nrefund uint256'],
        ['Disable', '', 'no inputs'],
        ['ExpirationChanged', '', '3 inputs:\n_tokenId uint256\n_amount uint256\n_timeAdded bool'],
        ['ExpireKey', '', '1 input:\ntokenId uint256'],
        ['KeyGranterAdded', '', '1 input:\naccount address'],
        ['KeyGranterRemoved', '', '1 input:\naccount address'],
        ['KeyManagerChanged', '', '2 inputs:\n_tokenId uint256\n_newManager address'],
        ['LockManagerAdded', '', '1 input:\naccount address'],
        ['LockManagerRemoved', '', '1 input:\naccount address'],
        ['NewLockSymbol', '', '1 input:\nsymbol string'],
        ['NonceChanged', '', '2 inputs:\nkeyManager address\nnextAvailableNonce uint256'],
        ['PricingChanged', '', '4 inputs:\noldKeyPrice uint256\nkeyPrice uint256\noldTokenAddress address\ntokenAddress address'],
        ['RefundPenaltyChanged', '', '2 inputs:\nfreeTrialLength uint256\nrefundPenaltyBasisPoints uint256'],
        ['RenewKeyPurchase', '', '2 inputs:\nowner address\nnewExpiration uint256'],
        ['Transfer', '', '3 inputs:\nfrom address\nto address\ntokenId uint256'],
        ['TransferFeeChanged', '', '1 input:\ntransferFeeBasisPoints uint256'],
        ['Withdrawal', '', '4 inputs:\nsender address\ntokenAddress address\nbeneficiary address\namount uint256'],
      ],
    },
    {
